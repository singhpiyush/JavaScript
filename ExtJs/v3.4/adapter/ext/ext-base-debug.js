...
(function () {
    var idSeed = 0,
        ...
        DOC = document,
        isStrict = 1, //DOC.compatMode == "CSS1Compat", PK - fixed the value to 1
        isOpera = check(/opera/),
...
//Below code prevents another web part to be added in the page
//This code overrides global Array object of javascript which should not happen under any circumstances
